...
export default function UploadJingle() {
  ...
  return (
    <DashboardLayout>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex space-x-3 pt-4">
                ...
                <Button 
                  type="button" 
                  variant="outline" 
                  className="flex-grow border-primary/20 hover:bg-primary/5 hover:text-primary"
                  onClick={resetForm}
                >
                  Cancel
                </Button>
      ...
      <Card className="mt-8 border border-gray-100 dark:border-gray-800 shadow-lg overflow-hidden">
