...
export default function BrandsPage() {
  ...
  const handleTourComplete = () => {
    ...
    toast({
      title: "Tour Complete!",
      description: "You've successfully completed the brand management tour.",
    });
  };
      ...
      <Card className="border-0 shadow-md">
        <CardHeader className="pb-3">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-3">
            <div className="flex-1" data-tour="brands-header">
        ...
        <CardContent>
          <div className="flex flex-col md:flex-row gap-4 mb-6 justify-between">
            <div className="relative w-full md:w-80" data-tour="search-input">
            ...
            <div className="flex gap-2" data-tour="bulk-actions">
                  ...
                  >
                    ...
                    <td className="px-4 py-3 border-b">
                      <div className="flex items-center gap-2">
                        <span data-tour={index === 0 ? "status-indicator" : undefined}>
                    ...
                    <td className="px-4 py-3 border-b text-center">
                      <Link to={`/brands/${location.id}/edit`}>
                        <Button 
                          ...
                          data-tour={index === 0 ? "edit-button" : undefined}
                        >
