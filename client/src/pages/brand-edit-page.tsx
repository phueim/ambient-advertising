...
import { Loader2, ArrowLeft, Save, Play, Pause, UploadCloud, Radio, Music, Clock, ChevronDown, X, Plus, Search, Filter, Shuffle, Trash2, ChevronLeft, ChevronRight, ListMusic, GripVertical, Edit, Copy, BookOpen, Users, Upload } from "lucide-react";
...
import { allTours } from "@/components/tour/tour-configs";
...
export default function BrandEditPage() {
  ...
  const [isTourLauncherOpen, setIsTourLauncherOpen] = useState(false);
  const [activeTour, setActiveTour] = useState<string | null>(null);

  // Available tours for each tab
  const generalTabTours = [
    {
      id: 'general-tab-tour',
  ...
  const handleTourComplete = () => {
    ...
    toast({
      title: "Tour Complete!",
      description: "You've mastered the brand configuration interface.",
    });
  };
  ...
  return (
    <DashboardLayout>
      <div className="max-w-7xl mx-auto px-3 sm:px-4 py-2">
          ...
          <div className={activeTab === "edit-playlist" ? "col-span-1" : activeTab === "playlist" ? "w-full" : "md:col-span-2"}>
            <Tabs defaultValue="general" className="w-full" onValueChange={setActiveTab}>
              <div className="mb-2 flex justify-start">
                <TabsList className="h-auto p-1 bg-muted rounded-lg flex justify-start overflow-x-auto scrollbar-hide w-fit min-w-0" data-tour="brand-tabs">
                  <TabsTrigger value="general" className="flex-shrink-0 min-w-fit px-2 sm:px-3 py-2 text-xs sm:text-sm whitespace-nowrap" data-tour="general-tab">General</TabsTrigger>
                  <TabsTrigger value="schedule" className="flex-shrink-0 min-w-fit px-2 sm:px-3 py-2 text-xs sm:text-sm whitespace-nowrap" data-tour="schedule-tab">Schedule</TabsTrigger>
                  ...
                  <TabsTrigger value="playlist" className="flex-shrink-0 min-w-fit px-2 sm:px-3 py-2 text-xs sm:text-sm whitespace-nowrap" data-tour="play-mode-tab">Play Mode</TabsTrigger>
                  <TabsTrigger value="edit-playlist" className="flex-shrink-0 min-w-fit px-2 sm:px-3 py-2 text-xs sm:text-sm whitespace-nowrap" data-tour="edit-playlist-tab">Edit Playlist</TabsTrigger>
                </TabsList>
              </div>
              
              {/* General Tab */}
              <TabsContent value="general" className="space-y-3 pt-2">
                <Card data-tour="basic-info-card">
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      ...
                      <Button
                        variant="ghost"
                        size="sm"
                        onClick={() => setIsTourLauncherOpen(true)}
              ...
              <TabsContent value="playlist" className="space-y-4 pt-2">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h3 className="text-lg font-semibold">Playback Mode Configuration</h3>
                    <p className="text-sm text-muted-foreground">Choose how music plays at this location</p>
                  </div>
                  <Button
                    variant="ghost"
                    size="sm"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4" data-tour="playback-mode-options">
              ...
              <TabsContent value="edit-playlist" className="space-y-4 pt-2">
                ...
                <Card data-tour="playlist-type-selector">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-10 gap-3 lg:gap-4 min-h-[400px] lg:min-h-[600px]">
                  ...
                  <div className="lg:col-span-6" data-tour="song-library">
                  ...
                  <div className="lg:col-span-4" data-tour="current-playlist">
                    <Card className="h-full">
                      <CardHeader className="pb-2">
                        <div className="flex items-center justify-between">
        ...
        {/* Tour Components */}
        <TourLauncher
          isOpen={isTourLauncherOpen}
          onClose={() => setIsTourLauncherOpen(false)}
          availableTours={activeTab === 'general' ? generalTabTours : 
                         activeTab === 'playlist' ? playModeTabTours : 
                         activeTab === 'edit-playlist' ? editPlaylistTabTours : []}
          onStartTour={handleStartTour}
        />
        
        {activeTour && allTours[activeTour] && (
          <TourEngine
            tour={allTours[activeTour]}
            isActive={true}
