...
export function QuickStartPage({ onPageChange }: QuickStartPageProps) {
  ...
  return (
    <div className="p-8 max-w-7xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <div className="dashboard-card cursor-pointer hover:shadow-lg transition-all duration-200" onClick={() => onPageChange('/')}>
        ...
        <div className="dashboard-card cursor-pointer hover:shadow-lg transition-all duration-200" onClick={() => onPageChange('/discover')}>
          <div className="flex flex-col items-center text-center space-y-4">
        ...
        <div className="dashboard-card cursor-pointer hover:shadow-lg transition-all duration-200" onClick={() => onPageChange('/pick-n-play')}>
          <div className="flex flex-col items-center text-center space-y-4">
        ...
        <div className="dashboard-card cursor-pointer hover:shadow-lg transition-all duration-200" onClick={() => onPageChange('/request-jingle')}>
          <div className="flex flex-col items-center text-center space-y-4">
        ...
        <div className="dashboard-card cursor-pointer hover:shadow-lg transition-all duration-200" onClick={() => onPageChange('/upload-jingle')}>
          <div className="flex flex-col items-center text-center space-y-4">
