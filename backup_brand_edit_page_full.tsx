...
export default function BrandEditPage() {
  ...
  return (
    <DashboardLayout>
      <div className={`${activeTab === "playlist" ? "w-full px-3 sm:px-6" : "max-w-7xl mx-auto px-3 sm:px-4"} py-2`}>
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
          ...
          <Button size="sm" variant="outline" onClick={handleSave} disabled={isLoading} className="border-[#b91c1c] text-[#b91c1c] hover:bg-[#b91c1c] hover:text-white">
          ...
          <div className={activeTab === "edit-playlist" ? "col-span-1" : activeTab === "playlist" ? "w-full" : "md:col-span-2"}>
            <Tabs defaultValue="general" className="w-full" onValueChange={setActiveTab}>
              <div className="w-full mb-2">
                <TabsList className="h-auto p-1 bg-muted rounded-lg flex sm:grid sm:grid-cols-5 overflow-x-auto scrollbar-hide w-full min-w-0">
              ...
              <TabsContent value="playlist" className="space-y-3 pt-2">
                      ...
                      <table className="min-w-full divide-y divide-gray-100 border border-gray-100 rounded-lg overflow-hidden">
                        <thead>
                          <tr className="bg-primary/5">
                            <th className="px-4 py-3 text-left text-xs font-medium text-primary uppercase tracking-wider">Select Playlists</th>
                            <th className="px-4 py-3 text-left text-xs font-medium text-primary uppercase tracking-wider">Select Playlist</th>
                            <th className="px-4 py-3 text-center text-xs font-medium text-primary uppercase tracking-wider">Time</th>
                          </tr>
                        </thead>
              ...
              <TabsContent value="edit-playlist" className="space-y-4 pt-2">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <RadioGroup value={playbackOrder} onValueChange={setPlaybackOrder} className="flex gap-6">
                          <div className="flex items-center space-x-2">
                            ...
                            <Label htmlFor="sequence" className="cursor-pointer text-sm">Sequential</Label>
                          </div>
                          <div className="flex items-center space-x-2">
                ...
                {/* Main Content Area */}
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 lg:gap-4 min-h-[400px] lg:min-h-[600px]">
                  {/* Song Library - 8 columns on large screens, full width on mobile */}
                    ...
                    <Card className="h-full">
                      ...
                      <CardContent className="space-y-3">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 p-3 bg-gray-50 rounded-lg">
                          ...
                          <Button 
                            size="sm"
                            className="h-8 bg-[#b91c1c] hover:bg-[#991b1b] text-white text-xs"
                            onClick={() => {
                              setSearchTerm("");
                  ...
                  {/* Current Playlist - 4 columns on large screens, full width on mobile */}
                  <div className="lg:col-span-4">
                    <Card className="h-full">
                      <CardHeader className="pb-2">
                        ...
                        <CardDescription className="text-sm">Drag to reorder • Click to remove</CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-3">
                        ...
                        {currentPlaylist.length > 0 && (
                          <div className="pt-4 border-t space-y-2">
                            ...
                            <div className="flex justify-between text-sm">
                              <span className="text-gray-600">Avg Song Length:</span>
                              <span className="font-medium">{calculateAverageDuration()}</span>
                            </div>
                          </div>
                        )}
                      </CardContent>
